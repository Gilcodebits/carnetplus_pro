...
export function Login() {
  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden bg-white">
      ...
      <div 
        className={`fixed top-6 left-1/2 -translate-x-1/2 z-[100] w-full max-w-md px-4 transition-all duration-500 transform ${
          displayError ? "translate-y-0 opacity-100" : "-translate-y-24 opacity-0 pointer-events-none"
        }`}
      >
